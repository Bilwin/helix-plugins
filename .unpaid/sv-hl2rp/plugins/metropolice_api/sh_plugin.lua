...
if CLIENT then
	rnlib.caching.AddModel("models/metropolice/c08.mdl")
	rnlib.caching.AddModel("models/metropolice/c08_female.mdl")
	rnlib.caching.AddModel("models/metropolice/c08_female_2.mdl")
	rnlib.caching.AddModel("models/metropolice/c08_female_3.mdl")
	rnlib.caching.AddModel("models/player/metropolice/c08.mdl")
	rnlib.caching.AddModel("models/player/metropolice/c08_female.mdl")
end
