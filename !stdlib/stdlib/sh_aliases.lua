...
-- custom ix aliases
local ix = ix
ix.command.add = ix.command.Add
ix.command.extract_args = ix.command.ExtractArgs
ix.command.find_all = ix.command.FindAll
ix.command.find_player = ix.command.FindPlayer
ix.command.has_access = ix.command.HasAccess
ix.command.parse = ix.command.Parse
ix.command.run = ix.command.Run
ix.command.send = ix.command.Send

ix.config.add = ix.config.Add
ix.config.get = ix.config.Get
ix.config.load = ix.config.Load
ix.config.save = ix.config.Save
ix.config.set = ix.config.Set
ix.config.set_default = ix.config.SetDefault

ix.char.register_var = ix.char.RegisterVar

ix.util.include = ix.util.Include
ix.util.dim_color = ix.util.DimColor
ix.util.draw_blur = ix.util.DrawBlur
ix.util.draw_blur_at = ix.util.DrawBlurAt
ix.util.draw_text = ix.util.DrawText
ix.util.emit_queued_sounds = ix.util.EmitQueuedSounds
ix.util.find_player = ix.util.FindPlayer
ix.util.get_chars = ix.util.GetCharacters
ix.util.include_dir = ix.util.IncludeDir
ix.util.get_utc_time = ix.util.GetUTCTime